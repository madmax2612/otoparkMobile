                ...
                <div className="modal-content" style={{padding:'20px'}}>
                    ...
                    <div className="modal-body" style={{ border: "1px solid white",padding:"20px" }}>
                        <div className="container">
                            <div className="row">
                                <div className="col-6 col-md-3 " style={{borderRight:'2px solid #00BBDC'}}>
                                <div>
                    ...
                    {/* <div class="modal-footer" style={{ border: "1px solid #00C569" }}>
                        <button type="button" class="btn" data-dismiss="modal" style={{ color: "#F7FE31" }}>Cancel</button>
                        <button type="button" class="btn" data-dismiss="modal" style={{ color: "#F7FE31" }}>YES</button>
                    </div> */}
                </div>
            </div>
